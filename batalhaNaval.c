...
int main() {
    ...
    printf("\nTabuleiro com saída de habilidade Cone:\n");
    exibirTabuleiro(tabuleiro);
    
    inicializarTabuleiro(tabuleiro);
    aplicarHabilidade(tabuleiro, cruz, 4, 4);
    printf("\nTabuleiro com saída de habilidade Cruz:\n");
    exibirTabuleiro(tabuleiro);
    
    inicializarTabuleiro(tabuleiro);
    aplicarHabilidade(tabuleiro, octaedro, 4, 4);
    printf("\nTabuleiro com saída de habilidade Octaedro:\n");
    exibirTabuleiro(tabuleiro);
...
int inicializarTabuleiro(int tabuleiro[TAMANHO][TAMANHO]) {
    ...
    tabuleiro[4][4] = 1;                                // Saida do primeiro navio
    return 0;
}
